...
route_file = "C:/Users/arahm/sumo-rl/sumo_rl/nets/2way-single-intersection/single-intersection-gen.rou.xml"
network_file = "C:/Users/arahm/sumo-rl/sumo_rl/nets/2way-single-intersection/single-intersection.net.xml"

if not os.path.exists(route_file):
    print(f"Route file not found: {route_file}. Generating it...")
    write_route_file(route_file, 400000, 100000)

if not os.path.exists(network_file):
    sys.exit(f"Network file not found: {network_file}. Please ensure it exists.")
